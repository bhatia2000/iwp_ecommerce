            ...
            <div class="row">
                    ...
                    <div class="left_sidebar_area">
                        <aside class="left_widgets p_filter_widgets sidebar_box_shadow">
                            ...
                            <div class="widgets_inner">
                                <ul class="list">
                                  <li class="sub-menu">
                                      <a href="category1.php" class=" d-flex justify-content-between" >
                                          First Year
                                  ...
                                  <li class="sub-menu">
                                        <a href="category2.php" class=" d-flex justify-content-between">
                                            Second Year
                                            <div class="right ti-plus"></div>
                                        </a>
                                        <ul>
                                    ...
                                    <li class="sub-menu">
                                        <a href="category3.php" class=" d-flex justify-content-between">
                                            Third Year
                                            <div class="right ti-plus"></div>
                                        </a>
                                        <ul>
                                    ...
                                    <li class="sub-menu">
                                        <a href="category4.php" class=" d-flex justify-content-between">
                                            Fourth Year
                                            <div class="right ti-plus"></div>
                                        </a>
                                        <ul>
                ...
                <div class="col-lg-9">
                    ...
                    <?php
                            ...
                            <div class="single_category_product">
                                <div class="single_category_img">
                                    ...
                                    <div class="category_product_text">
                                        <a href="single-product.html"><h5><?php echo $res['Name'] ?></h5></a>
                                        <p>Rs.<?php echo $res['Price'] ?></p>
                                    </div>
                                    <div><center><button style="border-radius: 50%;background-color: red;text-decoration-color:white;" data-toggle="modal" data-target="#<?php echo $res['Id']?>"><p>Discription</p></button>
                                                

                                                    <div class="modal fade jumbotron" id=<?php echo $res['Id']?> tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          <div class="container-fluid">
                                                            <div class="row">
                                                              <div class="col-md-4"><img src=<?php echo $res['Image'] ?> alt="Product Thumbnail" width="200"><p class="cp"><h2>Rs.<?php echo $res['Price'] ?></h2></p></div>
                                                              <div class="col-md-6 ml-auto"><?php echo $res['Description'] ?></div>
                                                            </div>
                                                          </div>
                                                        </div>
                                                      </div>
                                                ...
                                                <form method="post" action="incart.php">
                                                    ...
                                                    <button type="submit" style="border-radius: 50%;background-color: red;text-decoration-color:white;"><p>Add to Cart</button></p>
                                                </form>
                                    </center>
                                    </div>   
                                </div>
                        ...
                        $sql="select * from Record where id=2";
                        //print_r($sql);
                        $query=mysqli_query($conn,$sql);
                        while($res=mysqli_fetch_array($query))
                        {
                            ...
                            <div class="single_category_product">
                                <div class="single_category_img">
                                    ...
                                    <div><center><button style="border-radius: 50%;background-color: red;text-decoration-color:white;" data-toggle="modal" data-target="#<?php echo $res['Id']?>"><p>Discription</p></button>
                                                ...
                                                <form method="post" action=""><button type="submit" style="border-radius: 50%;background-color: red;text-decoration-color:white;"><p>Add to Cart</button></p></form>
                                    </center>
                                    </div>   
                                </div>
                            </div>
                        ...
                        $sql="select * from Record where id=3";
                        $query=mysqli_query($conn,$sql);
                        while($res=mysqli_fetch_array($query))
                        {
                        ?>
                        ...
                        $sql="select * from Record where id=4";
                        //print_r($sql);
                        $query=mysqli_query($conn,$sql);
                        while($res=mysqli_fetch_array($query))
                        {
