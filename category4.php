            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <?php
                        ...
                        $sql="select * from Record where Year=4";
                        //print_r($sql);
                            ...
                            <div class="single_category_product">
                                <div class="single_category_img">
                                    ...
                                    <div><center><button style="border-radius: 50%;background-color: red;text-decoration-color:white;" data-toggle="modal" data-target="#<?php echo $res['Id']?>"><p>Discription</p></button>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          <div class="container-fluid">
                                                            <div class="row">
                                                              <div class="col-md-4"><img src=<?php echo $res['Image'] ?> alt="Product Thumbnail" width="200"><p class="cp"><h2>Rs.<?php echo $res['Price'] ?></h2></p><button type="button" class="btn btn-outline-dark btn-lg">Add to Cart</button></div>
                                                ...
                                                <button style="border-radius: 50%;background-color: red;text-decoration-color:white;"><p>Add to Cart</button>
                                    </center></p>
                                    </div>   
                                </div>
                            </div>
